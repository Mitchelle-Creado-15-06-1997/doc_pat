     ...
     <div class="container">
      ...
      <div class="card card-login mx-auto mt-5">
        <div class="card-header">
           Enter DETAILS and whether book or cancel
        </div>
        <div class="card-body">
          <label>SOURCE-santacruz</label><br>
           <label>DESTINATION-churchgate</label><BR>
           <label>TIMINGS-12-56</label>
          <div class="text-center">
            ...
            <center> <input id="button" type="submit" name="submit" value="book"><input id="button" type="submit" name="cancel" value="cancel"></center>
          </form>
          </div>
        </div>
